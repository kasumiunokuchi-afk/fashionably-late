...
class ContactRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'tel0' =>  'required|numeric|digits_between:1,5',
    ...
    public function messages(){
         return [
             ...
             'tel0.numeric' => '電話番号は半角英数字でで入力してください',
             'tel0.max' => '電話番号は 5桁まで数字で入力してください',
             'tel1.required' => '電話番号を入力してください',
             'tel1.numeric' => '電話番号は半角英数字でで入力してください',
             'tel1.max' => '電話番号は 5桁まで数字で入力してください',
             'tel2.required' => '電話番号を入力してください',
             'tel2.numeric' => '電話番号は半角英数字でで入力してください',
